					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
							<div class="product-preview">
								<img src="img/<?php echo $row->produto; ?>" alt="">
							</div>
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<div>
								...
								<a class="review-link" href="#">10 Review(s) | Adicione seu review</a>
							</div>
							<div>
								<h3 class="product-price">R$<?php echo $row->valor; ?></del></h3>
							...
							<div class="product-options">
								<label>
									Tamanho
									<select class="input-select">
										<option value="0"><?php echo $row->tamanho; ?></option>
									</select>
								</label>
								<label>
									Cor
									<select class="input-select">
										<option value="0"><?php echo $row->cor; ?></option>
									</select>
								</label>
							</div>
							...
							<ul class="product-btns">
								<li><a href="#"><i class="fa fa-heart-o"></i> adicionar a lista de desejos</a></li>
								<li><a href="#"><i class="fa fa-exchange"></i> adicionar a comparar</a></li>
							</ul>
